...
# -*- coding: utf-8 -*-
#
# aiomonitor documentation build configuration file, created by
...
version = ".".join(_version_info.split(".")[:2])
...
man_pages = [(master_doc, "aiomonitor", "aiomonitor Documentation", [author], 1)]
